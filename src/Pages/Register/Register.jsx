...
const Register = () => {
  ...
  const handleRegister = (e) => {
    ...
    if (!validateMobile(mobile)) {
      ...
      // return;
      validationErrors.phone = 'Số điện thoại phải bắt đầu bằng số 0 và có đúng 10 chữ số';
    }
      ...
      <div className="register-container">
        <form className="register__form" onSubmit={handleRegister}>
          ...
          <div className="register__form__field">
            ...
            <p style={{ color: 'blue' }}>Email phải hợp lệ. Ví dụ: example@example.com</p>
          )}
          ...
          <div className="register__form__field">
            ...
            <p style={{ color: 'blue' }}>Mật khẩu phải dài hơn 8 ký tự</p>
          )}
